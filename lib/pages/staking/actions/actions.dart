      ...
      return Container(
        ...
        child: ListTile(
          leading: Container(
            ...
            child: i.success
                ? Image.asset(
                    'packages/polkawallet_plugin_edgeware/assets/images/staking/ok.png')
                : Image.asset(
                    'packages/polkawallet_plugin_edgeware/assets/images/staking/error.png'),
          ),
          title: Text(i.call),
        ...
        child: ListTile(
          leading: Container(
            ...
            child: i.eventId == 'Reward'
                ? SvgPicture.asset(
                    'packages/polkawallet_plugin_edgeware/assets/images/staking/reward.svg')
                : SvgPicture.asset(
                    'packages/polkawallet_plugin_edgeware/assets/images/staking/slash.svg'),
          ),
