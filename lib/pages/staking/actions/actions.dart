...
import 'package:polkawallet_plugin_edgeware/pages/staking/actions/rewardsChart.dart';
      ...
      return Container(
        ...
        child: ListTile(
          ...
          leading: Container(
            ...
            child: i.success
                ? SvgPicture.asset(
                    'packages/polkawallet_plugin_edgeware/assets/images/staking/ok.svg')
                : SvgPicture.asset(
                    'packages/polkawallet_plugin_edgeware/assets/images/staking/error.svg'),
          ),
          title: Text(i.call),
        ...
        child: ListTile(
          leading: Container(
            ...
            child: SvgPicture.asset(
                'packages/polkawallet_plugin_edgeware/assets/images/staking/${isReward ? 'reward' : 'slash'}.svg'),
          ),
              ...
              children: <Widget>[
                ...
                StakingInfoPanel(
                  ...
                  blockDuration: int.parse(widget
                          .plugin.networkConst['timestamp']['minimumPeriod']) *
                      2,
                  bonded: bonded,
                  unlocking: unlocking,
...
class StakingInfoPanel extends StatelessWidget {
  ...
  void _showUnlocking(BuildContext context) {
    final dic = I18n.of(context).getDic(i18n_full_dic_edgeware, 'staking');
    final dicGov = I18n.of(context).getDic(i18n_full_dic_edgeware, 'gov');
      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        ...
        cancelButton: CupertinoActionSheetAction(
          child: Text(I18n.of(context)
              .getDic(i18n_full_dic_edgeware, 'common')['cancel']),
          onPressed: () {
            Navigator.pop(context);
          },
        ),
