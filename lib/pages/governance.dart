                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            child: EntryPageCard(
                              ...
                              dic['democracy.brief'],
                              SvgPicture.asset(
                                'packages/polkawallet_plugin_edgeware/assets/images/gov/democracy.svg',
                                width: 96,
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            child: EntryPageCard(
                              ...
                              dic['council.brief'],
                              SvgPicture.asset(
                                'packages/polkawallet_plugin_edgeware/assets/images/gov/council.svg',
                                width: 96,
                                color: Theme.of(context).primaryColor,
                              ),
                              color: Colors.transparent,
                        ...
                        Padding(
                          ...
                          child: GestureDetector(
                            child: EntryPageCard(
                              ...
                              dic['treasury.brief'],
                              SvgPicture.asset(
                                'packages/polkawallet_plugin_edgeware/assets/images/gov/treasury.svg',
                                width: 96,
                                color: Theme.of(context).primaryColor,
                              ),
                              color: Colors.transparent,
