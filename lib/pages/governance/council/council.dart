...
import 'package:polkawallet_plugin_edgeware/common/components/infoItem.dart';
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          ...
          content: Text(I18n.of(context)
              .getDic(i18n_full_dic_edgeware, 'gov')['vote.remove.confirm']),
          actions: [
            CupertinoButton(
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: balance.length == 1
          ? null
          : Text(
              '${I18n.of(context).getDic(i18n_full_dic_edgeware, 'gov')['backing']}: ${Fmt.token(
