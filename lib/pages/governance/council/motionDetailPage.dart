...
import 'package:polkawallet_plugin_edgeware/pages/governance/council/council.dart';
import 'package:polkawallet_plugin_edgeware/pages/governance/govExternalLinks.dart';
...
class _MotionDetailPageState extends State<MotionDetailPage> {
  ...
  Widget build(BuildContext context) {
    final Map dic = I18n.of(context).getDic(i18n_full_dic_edgeware, 'gov');
    final CouncilMotionData motion = ModalRoute.of(context).settings.arguments;
    return Observer(
      builder: (BuildContext context) {
        ...
        if (widget.plugin.networkConst['treasury'] != null) {
          blockTime =
              widget.plugin.networkConst['timestamp']['minimumPeriod'] * 2;
        }
        ...
        child: Row(
          children: <Widget>[
            ...
            Text(I18n.of(context)
                .getDic(i18n_full_dic_edgeware, 'gov')['detail'])
          ],
        ),
        onTap: () {
          setState(() {
